package com.excellence_spring_jpa_jpql_query;
...
import com.excellence_spring_jpa_jpql_query.model.Tutorial;
import com.excellence_spring_jpa_jpql_query.repository.TutorialRepository;

@SpringBootApplication
public class SpringJpaQueryJpqlApplication implements CommandLineRunner {

	@Autowired
	private TutorialRepository tutorialRepository;

	public static void main(String[] args) {
		SpringApplication.run(SpringJpaQueryJpqlApplication.class, args);
	}
